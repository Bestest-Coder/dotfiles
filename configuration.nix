...
{config, lib, pkgs, self, ... }:
{
  ...
  users.users.bestest = {
    ...
    extraGroups = [ "networkmanager" "wheel" "libvirtd" "docker" "dialout" "video"];
    packages = with pkgs; [];
    openssh.authorizedKeys.keys = [
      ...
      # ien key
      "ssh-rsa  bestest@ien"
    ];
  };
