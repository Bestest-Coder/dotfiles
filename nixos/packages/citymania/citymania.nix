...
stdenv.mkDerivation rec {
  ...
  meta = with lib; {
    description = ''Fork of the open source clone of the Microprose game "Transport Tycoon Deluxe"'';
    mainProgram = "citymania";
    longDescription = ''
      CityMania is a fork of OpenTTD, which is a transportation economics simulator. In single player mode,
    ...
    '';
    homepage = "https://citymania.org/";
    changelog = "https://citymania.org/downloads";
    license = licenses.gpl2;
    platforms = platforms.linux;
    maintainers = with maintainers; [ jcumming fpletz bestest ];
  };
}
